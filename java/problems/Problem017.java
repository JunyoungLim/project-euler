...
public class Problem017 {
  ...
  private static final String[] UNIT = {"one", "two", "three", "four", "five", "six", "seven",
      "eight", "nine"};
  private static final String[] TENTH = {"twenty", "thirty", "forty", "fifty", "sixty", "seventy",
      "eighty", "ninety"};
  private static final String[] TEN = {"ten", "eleven", "twelve", "thirteen", "fourteen", "fifteen",
